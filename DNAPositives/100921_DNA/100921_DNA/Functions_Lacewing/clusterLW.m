function [coord_cell,coord_vect,K] = clusterLW(in,pixel_on,K)
...
% - thr : threshold parameters for clustering. thr(1) is on coordinates and
%   thr(2) is on value.
% - nmin : minimum amount of pixels to form a cluster.
